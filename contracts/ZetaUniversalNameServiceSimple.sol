...
// Simplified Universal App for testing without ZRC20
...
/// @title ZetaChain Universal Name Service (Simplified)
/// @notice Cross-chain domain name service using ZetaChain Universal App pattern
contract ZetaUniversalNameServiceSimple {
    event Registered(
        string indexed name, 
    ...
    // Simplified cross-chain transfer without ZRC20
    function crossChainTransfer(
        ...
        // Make cross-chain call (without ZRC20 for testing)
