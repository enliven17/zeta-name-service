...
// ZetaChain Universal App pattern için doğru implementasyon
...
/// @title ZetaChain Universal Name Service (Correct Implementation)
/// @notice Cross-chain domain name service using ZetaChain Universal App pattern
contract ZetaUniversalNameServiceCorrect {
    event Registered(
        string indexed name, 
    ...
    // Cross-chain transfer using correct Universal App pattern
    function crossChainTransfer(
        ...
        // Make cross-chain call using correct pattern
